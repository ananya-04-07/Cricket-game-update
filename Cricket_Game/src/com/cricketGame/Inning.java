...
public class Inning {
    ...
    public void playMatch(String team1, String team2, List<String> player1, List<String> player2, MatchController matchController) {
        ...
        for (ballPlayedTeam = 1; ballPlayedTeam <= totalBall; ballPlayedTeam++) {
            ...
            int run = GetRandomUtil.getRun(runNo, probabilityOfRun, runNo.length);
            if (run == 7) {
                System.out.println("================================================");
        ...
        matchController.getTeamDetailUtil().teamRunUpdate(team1, totRun, ballPlayedTeam);
        matchController.getTeamDetailUtil().teamRunRateUpdate((float) totRun / matchController.getInning().getOver(), team1);
    }

    public void inningStart(MatchController matchController) {
        PlayerDetailsUtil playerDetailsUtil = new PlayerDetailsUtil();
        ...
        playerDetailsUtil.insertPlayerDetail(matchController.getPlayer(),matchController);
        ...
        matchController.getInning().playMatch(matchController.getTeam1(), matchController.getTeam2(), player1, player2,matchController);
        System.out.println("============== SECOND INNING ============================");
        System.out.println("========================================================");
        System.out.println("============ " + matchController.getTeam2() + " ready for batting ========");
        System.out.println("========================================================");
        matchController.getInning().playMatch(matchController.getTeam2(), matchController.getTeam2(), player2, player1,matchController);
    }
}
