...
public class Inning {
    ...
    public static void matchStart(String team1, String team2, List player, Inning inning) {
        ...
        ScoreBoard.getPlayerDetails(opener1, team1, PlayerDetailsUtil.jerseyColor(team1), "Batsman");
        ScoreBoard.getPlayerDetails(opener2, team1, PlayerDetailsUtil.jerseyColor(team1), "Batsman");
        ScoreBoard.getPlayerDetails(baller, team2, PlayerDetailsUtil.jerseyColor(team2), "Baller");
        int teamRun = 0;
